...
namespace NN
{
	...
	namespace internal
	{
		...
		inline void evolve_Run(double *output0, double *output1, const double *input, const Data *n0, const Data *n1)
		{
			Single::run(output0, input, n0);
			Single::run(output1, input, n1);
		}
	...
	namespace Solution
	{
		...
		void run(double *output0, double *output1, const double *input, const Solution *s)
		{
			internal::evolve_Run(output0, output1, input, &s->current, &s->tmp);
		}

		inline void run(double *output, const double *input, const Solution *s)
		{
